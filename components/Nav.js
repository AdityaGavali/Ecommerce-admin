...
function Nav({show}) {
    ...
    const activeIcon = inactiveIcon+'fill-primary text-blue-900'
  ...
  return (
    <aside className={(show?'left-0':'-left-full') + " text-gray-500 p-4 fixed w-full bg-bgGray h-full top-0 md:static md:w-auto transition-all z-10"}>
      <Logo/>
